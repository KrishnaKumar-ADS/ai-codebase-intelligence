...
Task types:
  ...
  summarize    → Gemini 2.0 Flash
    embedding    → Gemini embedding model from settings
...
ROUTING_TABLE: dict[TaskType, tuple[Provider, str]] = {
    ...
    TaskType.EMBEDDING: (Provider.GEMINI,    settings.resolved_embedding_model),
}
...
FALLBACK_TABLE: dict[TaskType, tuple[Provider, str]] = {
    ...
    TaskType.EMBEDDING: (Provider.GEMINI,     settings.resolved_embedding_model),  # No fallback for embedding
}
